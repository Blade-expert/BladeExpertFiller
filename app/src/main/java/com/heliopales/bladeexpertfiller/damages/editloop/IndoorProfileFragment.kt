 ...
 * Use the [IndoorProfileFragment.newInstance] factory method to
...
class IndoorProfileFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_indoor_profile, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment IndoorProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IndoorProfileFragment().apply {
    ...
    override fun onClick(v: View) {
        ...
        if(v is Button){
            when (v.id) {
                R.id.button_ipna -> damage.profileDepth = null
